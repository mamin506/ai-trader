...
def test_quick_backtest():
    ...
    # Run quick backtest
    print("\nRunning VectorBT backtest on AAPL (2024)...")
    result = api.quick_backtest(
        strategy=strategy, symbol="AAPL", start_date="2024-01-01", end_date="2024-12-31"
    )
...
def test_batch_backtest():
    ...
    results = api.batch_backtest(
        strategy=strategy, symbols=symbols, start_date="2024-01-01", end_date="2024-12-31"
    )
